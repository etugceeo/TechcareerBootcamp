namespace FormsApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product { ProductId = 3, Name = "IPhone 16", Price = 7000, IsActive = false, Image = "3.jpg", CategoryId = 1 });
            _products.Add(new Product { ProductId = 4, Name = "IPhone 17", Price = 8000, IsActive = true, Image = "4.jpg", CategoryId = 1 });
            _products.Add(new Product { ProductId = 5, Name = "Macbook Air", Price = 9000, IsActive = false, Image = "5.jpg", CategoryId = 2 });
